...
<script type="text/javascript">
  cj(document).ready(function() {
    ...
    //var test = cj("input:radio[name=repeats_by]:checked").val();
    //alert(test);
    /*cj('input:radio[name=repeats_by]').click(function() {
        ...
        if(cj(this).val() == 2){
            cj('#start_action_date_1').show();
            cj('#start_action_date_2').show();
        }
    });*/
     /*cj('#limit_to').hide();
     cj('#start_action_date_1').hide();
     cj('#start_action_date_2').hide();*/
